      ...
      <>
        ...
        <View style={styles.headerContainer1}>
          ...
          <View style={styles.rateCardsContainer}>
            ...
            <View style={styles.rateCard}>
              <View style={styles.rateCardContent}>
                <View style={styles.rateIconContainer}>
                  <Animated.View style={[styles.animatedCoinContainer, createAnimatedStyle(goldAnimation)]}>
                    <Image 
            ...
            <View style={styles.rateCard}>
              <View style={styles.rateCardContent}>
                <View style={styles.rateIconContainer}>
                  <Animated.View style={[styles.animatedCoinContainer, createAnimatedStyle(silverAnimation)]}>
                    <Image 
        ...
        <View style={styles.contentWrapper}>
          ...
          <Text style={styles.contentText1}>
            The ideal place to join a savings scheme and save up to buy your dream jewels. 
            BMG DIGIGOLD empowers you to save and buy jewels conveniently in the palm of your hand. 
            Start saving in gold from today.
          </Text>
        </View>

        <View style={styles.titleSpacer}>
          <View style={styles.sectionHeaderContainer}>
            <TextDefault textColor={colors1.primaryText} style={styles.titletext} H5 bold>
              Your Schemes
            </TextDefault>
          ...
          >
            {loading ? (
              ...
              <TextDefault textColor={colors1.error}>No Schemes available.</TextDefault>
            )}
          </ScrollView>
        </View>
        ...
        <View style={styles.titleSpacer}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {loading ? (
              ...
              <TextDefault textColor={colors1.error}>No Gold Plans available.</TextDefault>
            )}
          </ScrollView>
        </View>
